...
<html lang="en"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/><meta name="theme-color" content="#f6dce7"/><meta name="description" content="Elfie's local Eorzea mailbox."/><title>Elfie's Pawpost</title><link rel="icon" type="image/svg+xml" href="/favicon.svg"/></head><body><div id="root"></div><script type="module" src="/pawpost/main.tsx"></script></body></html>`);
