...
export function normalizePreferences(value) {
  const defaults = { sound: false, desktop: false, tell: true, emote: true, target: true, mention: true, whileVisible: false };
  const input = value && typeof value === 'object' ? value : {};
  const result = { ...defaults, channels: { ...channelDefaults } };
